'''
Purpose : 
This script collates all the progress csvs till Apr 2018 - March 2019 into one csv.

How to run:
Needs python shell.
1. execfile('<path>/progresscsv_collation')
2. prompts for the path of the data folder which has the progress csvs.
'''
